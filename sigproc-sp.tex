...
\begin{itemize}
  ...
  \item[-] \textit{Back-end design}. Global design of the new involved software. Debugging and optimization. 
  \item[-] \textit{Front-end design}. Global design of the new involved software. Debugging and optimization. Graphical User Interface improvement. 
  \item[-] \textit{Platform development}. Implementation and integration of both back and front end. Development of the final demo. 
